...
nohup taskset -c 0,1 python3 /home/saus/crypto-crew-4.0/brain/autonomous_agent.py $CORES $RAM > /home/saus/crypto-crew-4.0/brain/agent_crew.log 2>&1 &
AGENT_PID=$!

# Start the memory monitor
nohup /home/saus/crypto-crew-4.0/brain/monitor_mem.sh $AGENT_PID 6291456 > /home/saus/crypto-crew-4.0/brain/monitor_low.log 2>&1 &
